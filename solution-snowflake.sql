...
INSERT INTO sources VALUES
	('2025-02-06','2025-02-12 09:38:25.999982000'),
...
CREATE OR REPLACE PROCEDURE task_2()
RETURNS STRING
LANGUAGE SQL
AS $$
DECLARE
    ...
    cur CURSOR FOR 
        SELECT src_date1, src_date2, COALESCE(LAG(src_date1) OVER (ORDER BY src_date1), '2025-01-28'::DATE) AS src_date3
        FROM sources;
BEGIN
    FOR record IN cur DO
        proc_date1 := record.SRC_DATE1;
        proc_date2 := record.SRC_DATE2;
        proc_date3 := record.SRC_DATE3;

        INSERT INTO destination VALUES (:proc_date1, :proc_date2, :proc_date3);
    END FOR;
  
    RETURN 'task_2 executed successfuly';
END;
$$;
